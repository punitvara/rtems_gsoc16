...
void epwm_pinmux_setup(uint32_t pwm_or_pin_id)
{
  switch(pwm_or_pin_id)  {
	case BBB_EPWM2:
		REG(AM335X_PADCONF_BASE + CONTROL_CONF_GPMC_AD(9)) = BBB_MUXMODE(BBB_MUX4);
		REG(AM335X_PADCONF_BASE + CONTROL_CONF_GPMC_AD(8)) = BBB_MUXMODE(BBB_MUX4);
		REG(AM335X_PADCONF_BASE + CONTROL_CONF_LCD_DATA(0)) = BBB_MUXMODE(BBB_MUX3);
		REG(AM335X_PADCONF_BASE + CONTROL_CONF_LCD_DATA(1)) = BBB_MUXMODE(BBB_MUX3);
		break;
	case BBB_EPWM1:
		REG(AM335X_PADCONF_BASE + CONTROL_CONF_LCD_DATA(11)) = BBB_MUXMODE(BBB_MUX2);
		REG(AM335X_PADCONF_BASE + CONTROL_CONF_LCD_DATA(10)) = BBB_MUXMODE(BBB_MUX2);
		REG(AM335X_PADCONF_BASE + CONTROL_CONF_GPMC_AD(2)) = BBB_MUXMODE(BBB_MUX6);
		REG(AM335X_PADCONF_BASE + CONTROL_CONF_GPMC_AD(3)) = BBB_MUXMODE(BBB_MUX6);
		break;
	case BBB_EPWM0:
